...
window.geometry('600x800')                         # Window 크기

# Sub Title
subtitleFrame = tk.Frame(window, width=600, height=30, relief='solid', bd=2)
...
# Process Finder
processRootFrame = tk.Frame(window, width=600, height=30, relief='solid', bd=2)
processRootFrame.pack(fill='both')

processChildTitleFrame = tk.Frame(processRootFrame, relief='solid', bd=1)
